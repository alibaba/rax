...
export type HeaderConfig = {
  ...
  // // Renders a custom left component
  // renderLeft?: Element<*> |
  //   (navigation: NavigationProp<*>, canGoBack: boolean) => Element<*>,
  // // Renders a custom navigation bar background
  // renderBackground?: $NavigationThunk<Element<*>>,
};
...
export type TabBarConfig = {
   ...
   */
  icon?: (options: { tintColor: string, focused: boolean }) => ?Element<*>;
  /**
