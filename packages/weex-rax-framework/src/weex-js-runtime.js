...
console.error('Weex JS Runtime 0.23.6');
...
function createInstance (id, code, config, data) {
  ...
  console.warn('YACHENG config', config);
  var instanceContext = createInstanceContext(id, config, data);

  console.error('YACHENG Weex JS Runtime 0.23.6 instanceContext');
  console.error(typeof framework.createInstance);
