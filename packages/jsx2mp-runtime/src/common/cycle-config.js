...
const PAGE_EVENT_HANDLE_LIST = ['onBack', 'onKeyboardHeight', 'onOptionMenuClick', 'onPopMenuClick',
  'onPullIntercept', 'onPullDownRefresh', 'onTitleClick', 'onTabItemTap', 'beforeTabItemTap', 'onResize'
]
const PAGE_CYCLE_LIST = ['componentDidMount', 'componentDidUpdate', 'componentWillMount', 
