...
declare namespace JSX {
  ...
  interface ElementClass extends Rax.Component<any, any> {
  }
  ...
  interface DOMAttributes extends Rax.RaxDOMAttributes {
    // Image Events
  ...
  interface HTMLAttributes extends Rax.ClassAttributes<any>, DOMAttributes {
