...
async function build({ package: packageName, entry = 'src/index.js', name, shouldMinify = false, shouldMangleProps = false, format = 'umd' }) {
  const output = {
    name,
    exports: 'named',
    sourcemap: true
...
build({ package: 'rax', name: 'Rax', shouldMinify: true, shouldMangleProps: true});
